...
const TRANSLATIONS: Translations = {
  en: {
    ...
    countdown: {
      ...
      noEvents: 'No events on the radar yet!',
      noEventsHint: 'Add your first event or pick a quick template below',
      quickAdd: 'Quick Add',
      orCustom: 'or create your own',
  ...
  de: {
    ...
    countdown: {
      ...
      noEvents: 'Noch keine Events auf dem Radar!',
      noEventsHint: 'Füge dein erstes Event hinzu oder wähle eine Vorlage',
      quickAdd: 'Schnell hinzufügen',
      orCustom: 'oder eigenes erstellen',
      categoryLabel: 'Kategorie',
      happening: 'Findet jetzt statt!',
      tomorrow: 'Morgen!',
      ...
      soExciting: 'Wie aufregend!',
      cantWait: 'Kaum zu warten!',
      wayToGo: 'Weiter so!',
    },
    shared: {
      languageButton: 'EN',

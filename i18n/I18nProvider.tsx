...
const TRANSLATIONS: Translations = {
  en: {
    landing: {
      ...
      // Signup Guide
      guideTag: 'GETTING STARTED',
      guideTitle: 'How to Sign Up',
      guideSubtitle: 'Whether you\'re a parent at home or a teacher in school — get your hub running in minutes.',
      guideParentTitle: 'Parent / Family',
      guideParentTag: 'Home Setup',
      guideP1Title: 'Tap "Start Mission"',
      guideP1Desc: 'Hit the big button on this page to begin creating your family hub.',
      guideP2Title: 'Enter Your Email & PIN',
      guideP2Desc: 'Provide your name, a valid email address, and choose a 4-digit PIN as your secret code.',
      guideP3Title: 'Verify Your Email',
      guideP3Desc: 'Check your inbox for a verification link. Click it to activate your account.',
      guideP4Title: 'Save Your Recovery Key',
      guideP4Desc: 'A unique recovery key is shown — screenshot or write it down. You\'ll need it if you forget your PIN.',
      guideP5Title: 'Add Your Children',
      guideP5Desc: 'Create profiles for each child with a name and secret word. They\'ll use these to log in independently.',
      guideP6Title: 'Kids Log In Anywhere',
      guideP6Desc: 'Children can sign in from any device using their name + secret word. No email needed for kids!',
      guideParentCta: 'Create Family Hub',
      guideSchoolTitle: 'Teacher / School',
      guideSchoolTag: 'Classroom Setup',
      guideS1Title: 'Tap "Start Mission"',
      guideS1Desc: 'Begin setup by clicking the main button. Choose "Teacher" as your role during signup.',
      guideS2Title: 'Use Your School Email',
      guideS2Desc: 'Enter your name, school email address, and a 4-digit PIN.',
      guideS3Title: 'Verify Your Email',
      guideS3Desc: 'Confirm your email via the link sent to your inbox. This secures your teacher account.',
      guideS4Title: 'Save Your Recovery Key',
      guideS4Desc: 'Keep your recovery key safe — it\'s your backup if you ever lose access.',
      guideS5Title: 'Add Students to Your Class',
      guideS5Desc: 'Create a profile for each student with a name and secret word. Set a class code for easy grouping.',
      guideS6Title: 'Print Login Handouts',
      guideS6Desc: 'Use the Teacher Dashboard to generate printable login cards with each student\'s name and secret word.',
      guideS7Title: 'Students Log In Independently',
      guideS7Desc: 'Students sign in from any school device with their name + secret word + class code. No email needed!',
      guideSchoolCta: 'Create Classroom Hub',
      guideTip1Title: 'Safe & Private',
      guideTip1Desc: 'All data stays in your account. Kids never need an email address.',
      guideTip2Title: 'Works on Any Device',
      guideTip2Desc: 'Phone, tablet, laptop, or desktop — the hub works everywhere with a browser.',
      guideTip3Title: 'Track Progress',
      guideTip3Desc: 'Parents and teachers get dashboards with real analytics on every child\'s learning journey.',
    },
    login: {
      signInTitle: 'Sign In',
  ...
  de: {
    landing: {
      ...
      // Signup Guide
      guideTag: 'ERSTE SCHRITTE',
      guideTitle: 'So meldest du dich an',
      guideSubtitle: 'Ob Eltern zu Hause oder Lehrkraft in der Schule — dein Hub ist in wenigen Minuten startklar.',
      guideParentTitle: 'Eltern / Familie',
      guideParentTag: 'Zuhause einrichten',
      guideP1Title: '„Mission starten" tippen',
      guideP1Desc: 'Drücke den großen Button auf dieser Seite, um deinen Familien-Hub zu erstellen.',
      guideP2Title: 'E-Mail & PIN eingeben',
      guideP2Desc: 'Gib deinen Namen, eine gültige E-Mail-Adresse und eine 4-stellige PIN als Geheimcode ein.',
      guideP3Title: 'E-Mail bestätigen',
      guideP3Desc: 'Prüfe dein Postfach und klicke den Bestätigungslink, um dein Konto zu aktivieren.',
      guideP4Title: 'Wiederherstellungsschlüssel sichern',
      guideP4Desc: 'Ein einzigartiger Schlüssel wird angezeigt — mache einen Screenshot oder notiere ihn. Du brauchst ihn bei PIN-Verlust.',
      guideP5Title: 'Kinder hinzufügen',
      guideP5Desc: 'Erstelle Profile für jedes Kind mit Name und Geheimwort. Damit loggen sie sich eigenständig ein.',
      guideP6Title: 'Kinder loggen sich überall ein',
      guideP6Desc: 'Kinder melden sich auf jedem Gerät mit Name + Geheimwort an. Keine E-Mail nötig!',
      guideParentCta: 'Familien-Hub erstellen',
      guideSchoolTitle: 'Lehrkraft / Schule',
      guideSchoolTag: 'Klasse einrichten',
      guideS1Title: '„Mission starten" tippen',
      guideS1Desc: 'Starte die Einrichtung über den Hauptbutton. Wähle bei der Anmeldung „Lehrer" als Rolle.',
      guideS2Title: 'Schul-E-Mail verwenden',
      guideS2Desc: 'Gib deinen Namen, deine Schul-E-Mail und eine 4-stellige PIN ein.',
      guideS3Title: 'E-Mail bestätigen',
      guideS3Desc: 'Bestätige deine E-Mail über den zugesandten Link. Das sichert dein Lehrer-Konto.',
      guideS4Title: 'Wiederherstellungsschlüssel sichern',
      guideS4Desc: 'Bewahre deinen Schlüssel sicher auf — er ist dein Backup bei Zugangsverlust.',
      guideS5Title: 'Schüler zur Klasse hinzufügen',
      guideS5Desc: 'Erstelle ein Profil für jeden Schüler mit Name und Geheimwort. Lege einen Klassencode fest.',
      guideS6Title: 'Login-Kärtchen drucken',
      guideS6Desc: 'Nutze das Lehrer-Dashboard, um druckbare Login-Karten mit Name und Geheimwort zu erstellen.',
      guideS7Title: 'Schüler loggen sich eigenständig ein',
      guideS7Desc: 'Schüler melden sich auf jedem Schulgerät mit Name + Geheimwort + Klassencode an. Keine E-Mail nötig!',
      guideSchoolCta: 'Klassen-Hub erstellen',
      guideTip1Title: 'Sicher & Privat',
      guideTip1Desc: 'Alle Daten bleiben in deinem Konto. Kinder brauchen keine E-Mail-Adresse.',
      guideTip2Title: 'Auf jedem Gerät',
      guideTip2Desc: 'Handy, Tablet, Laptop oder Desktop — der Hub funktioniert überall mit einem Browser.',
      guideTip3Title: 'Fortschritt verfolgen',
      guideTip3Desc: 'Eltern und Lehrkräfte bekommen Dashboards mit echten Analysen zu jedem Lernfortschritt.',
    },
    login: {
